...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#select-autocomplete-generos').select2({ 
				width: '300px',
				placeholder: 'Buscador',
				minimumInputLength: 2,
				ajax: {
				    url: '/api/generos/buscar',
				    ...
				    processResults: function (data) {
				        ...
				        for(var genero of data) {
				        	nuevosDatos.push({ id: genero.idGenero, text: genero.nombre});
				        }
				...
				window.location = '/generos/' + event.params.data.id;
			});
		});
	...
	<sec:authorize access="isAuthenticated()">
		<header>
		    ...
		    <div class="container-fluid">
		     <a class="navbar-brand" href="<c:url value="/generos"/>">Generos</a>
		      ...
		      <div class="collapse navbar-collapse" id="navbarCollapse">
		        <ul class="navbar-nav me-auto mb-2 mb-md-0">
		         ...
		         <form class="form-inline mt-2 mt-md-0">
			      	<select id="select-autocomplete-generos"></select>
			      </form>
		      </div>
		    </div>
		  </nav>
